...
/**
 * This is a test class for the class ViewMashupOverviewJSON.
 * 
 * @author Alexander
 * 
 */
public class ViewMashupOverviewJSONTest {
	...
	public void mainTest() throws ExceptionMP {
		...
		// create ViewMashupOverviewJSON instance and check values
		ViewMashupOverviewJSON view = new ViewMashupOverviewJSON(
				new ModelMashupOverview(env));
		String content = view.getContent();
		assertTrue(content.contains("mashups"));
		env.close();
	}
